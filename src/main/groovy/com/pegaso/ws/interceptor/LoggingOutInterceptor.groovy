...
public class LoggingOutInterceptor extends AbstractLoggingInterceptor {
    Logger LOG = LogUtils.getLogger(LoggingOutInterceptor.class);
    String LOG_SETUP = LoggingOutInterceptor.class.getName() + ".log-setup";
    ...
    class LoggingCallback implements CachedOutputStreamCallback {
        ...
        public void onClose(CachedOutputStream cos) {
            ...
            org.apache.cxf.message.Message inMessage = (org.apache.cxf.message.Message)message.getExchange().getInMessage()
            InputStream is = inMessage.getContent(InputStream.class);
            InputStream out = message.getContent(InputStream.class)
            ...
            String theString = IOUtils.toString(is, encoding);
